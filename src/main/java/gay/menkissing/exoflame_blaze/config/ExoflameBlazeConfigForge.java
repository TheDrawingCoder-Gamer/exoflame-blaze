...
public class ExoflameBlazeConfigForge {
    ...
    public static final IExoflameBlazeConfig INSTANCE = new IExoflameBlazeConfig() {
        @Override
        public int boostRate() {
            return EXOFLAME_BOOST_RATE.get();
        }

        @Override
        public int seethingBoostRate() {
            return EXOFLAME_SEETHING_BOOST_RATE.get();
        }
    };
}
